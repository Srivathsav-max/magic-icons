...
function Frame({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
	return (
		<div
			data-slot="frame"
...
function FrameTitle({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
	return (
		<div
...
function FrameDescription({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
	return (
		<div
